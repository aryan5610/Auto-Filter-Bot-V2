class script(object):
    ...
    START_MSG = """ <b>Hi {}
this is anime search bot :D ..!! Exclusively to download anime from all telegram !! 
Search all anime at one place @animerivs !! Join our group and search for anime there and you could download from whole telegram!'
